    ...
    <div className="d-flex" style={{ minHeight: "100vh" }}>
      ...
      >
        <div className="p-3">
          ...
          <div className="mb-4">
            <small className="text-muted">Resident Portal</small>
          ...
          <nav className="nav flex-column">
            <Link 
              ...
              className={`nav-link text-white ${isActive("/resident/dashboard") ? "bg-secondary bg-opacity-50 rounded" : ""}`}
            >
            ...
            <Link 
              ...
              className={`nav-link text-white ${isActive("/resident/pickup-requests") ? "bg-secondary bg-opacity-50 rounded" : ""}`}
            >
      ...
      <div style={{ marginLeft: sidebarOpen || window.innerWidth >= 768 ? "250px" : "0", flex: 1 }}>
        ...
        <nav className="navbar navbar-light bg-white border-bottom">
          <div className="container-fluid">
            ...
            <span className="navbar-brand mb-0 h1 d-none d-md-block">Resident Portal</span>
